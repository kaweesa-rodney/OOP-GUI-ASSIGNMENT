...
def run_gui():
    gui_script = BASE_DIR / "GUIControls.py"
    if not gui_script.exists():
        sys.exit(f"GUIControls.py not found in {BASE_DIR}")
    
    print("Launching GUIControls.py...")
    subprocess.check_call([str(PYTHON_BIN), str(gui_script)])
